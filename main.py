...
from services.employee_service import EmployeeService, NameMatcher
...
async def health_check(request: Request) -> JSONResponse:
    ...
    health_status = {
        ...
        "database": {
            "connected": __import__('utils.database').DatabaseConnection.test_connection()
        }
    }
...
if __name__ == "__main__":
    ...
    if __import__('utils.database').DatabaseConnection.test_connection():
